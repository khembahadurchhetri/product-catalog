...
export default function AdminDashboardClient({ sessionUserEmail }: { sessionUserEmail: string }) {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto min-h-screen bg-gray-50">
      ...
      <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-gray-100 shadow-xs">
        <div>
          <h2 className="text-base font-bold text-gray-900">Admin Master Dashboard</h2>
          <p className="text-xs text-gray-500 mt-0.5">
            System Identity Scope: <span className="font-semibold text-red-600">{sessionUserEmail}</span>
          </p>
        </div>
        <button
      ...
      {/* Catch Empty states or network faults gracefully */}
      {loading ? (
        ...
        <>
          ...
          {/* Products Data Listing Grid Table */}
      ...
      {/* PRODUCT UPLOAD DRAWER / MODAL PANEL */}
      {isUploadPanelOpen && (
